...
public class ReissueController {
    ...
    public ResponseEntity<?> reissue(HttpServletRequest request, HttpServletResponse response) {
        ...
        //make new JWT
        String newAccess = jwtUtil.createJwt("access",userId, username, nickname, role, 600000L);
        String newRefresh = jwtUtil.createJwt("refresh",userId, username, nickname, role, 86400000L);
